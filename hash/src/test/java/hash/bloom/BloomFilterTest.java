...
public class BloomFilterTest {
    ...
    @Test
    public void testGetOptimalNumberOfHashFunctions() throws Exception {
    ...
    @Test
    public void testGetOptimalNumberOfBits() throws Exception {
    ...
    @Test
    public void testExpectedFalsePositiveProbability() throws Exception {
